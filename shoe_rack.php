...
<body>
    ...
    <h1 class="text-center mb-4">Welcome to the shoe_rack Section</h1>
    <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php if (isset($_SESSION['email'])) { ?>
                            ...
                            <a href="buy_now.php?id=<?php echo $data['id']; ?>&category=shoe_rack" class="btn btn-success">Buy Now</a>
