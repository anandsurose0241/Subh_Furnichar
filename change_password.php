...
if (isset($_POST['update_password']) && $_POST['otp'] && $_POST['password'] && $_POST['confirmpassword']) {
    ...
    if ($run) {
        $query1 = "UPDATE `users` SET `otp`='null' WHERE `password`='$password'";
...
<?php include_once("header.php"); ?>  
    ...
    <main class="row m-auto my-2 border border-2 border-info">
        ...
        <form method="post" class="col-6 border border-info py-3 my-5">
            ...
            <input type="text" name="password" class="form-control my-4" placeholder="Enter New Password">
            <input type="text" name="confirmpassword" class="form-control my-4" placeholder="Enter Confirm Password">
        ...
        function startTimer() {
            ...
            timerInterval = setInterval(function () {
                ...
                if (timeLeft <= 0) {
                    ...
                    window.location.replace("./otp_expired.php");
